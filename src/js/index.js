...
botoes.forEach(botao => {
    botao.addEventListener("click", () => {
        botao.classsList.add("selecionado");
    });
});
*/
...
botoes.forEach((botao, indice) => {
	botao.addEventListener("click", () => {
		...
		mapas[indice].classList.add("selecionado");
	});
});

function desselecionarmapa() {
	const mapaSelecionado = document.querySelector(".mapa.selecionado");
	mapaSelecionado.classList.remove("selecionado");
}
